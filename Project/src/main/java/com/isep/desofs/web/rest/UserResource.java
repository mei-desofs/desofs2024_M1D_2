...
/**
 * REST controller for managing {@link com.isep.desofs.domain.User}.
 */
@RestController
...
public class UserResource {
     ...
     */
    @GetMapping("")
    public List<UserDTO> getAllUsers(@RequestParam(name = "filter", required = false) String filter) {
        if ("roleuser-is-null".equals(filter)) {
            log.debug("REST request to get all Users where roleUser is null");
            return userService.findAllWhereRoleUserIsNull();
        }
