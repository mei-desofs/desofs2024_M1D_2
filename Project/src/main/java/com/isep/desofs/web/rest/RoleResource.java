...
/**
 * REST controller for managing {@link com.isep.desofs.domain.Role}.
 */
@RestController
...
public class RoleResource {
     ...
     */
    @GetMapping("")
    public List<RoleDTO> getAllRoles(@RequestParam(name = "filter", required = false) String filter) {
        if ("roleuser-is-null".equals(filter)) {
            log.debug("REST request to get all Roles where roleUser is null");
            return roleService.findAllWhereRoleUserIsNull();
        }
