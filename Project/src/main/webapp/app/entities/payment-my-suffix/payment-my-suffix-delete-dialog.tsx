...
import { getEntity, deleteEntity } from './payment-my-suffix.reducer';

export const PaymentMySuffixDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="onlineShopApp.payment.delete.question">Are you sure you want to delete Payment {paymentEntity.id}?</ModalBody>
      <ModalFooter>
...
export default PaymentMySuffixDeleteDialog;
