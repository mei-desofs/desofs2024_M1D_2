...
import { getEntity, deleteEntity } from './role-my-suffix.reducer';

export const RoleMySuffixDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="onlineShopApp.role.delete.question">Are you sure you want to delete Role {roleEntity.id}?</ModalBody>
      <ModalFooter>
...
export default RoleMySuffixDeleteDialog;
