...
import { IPortfolioMySuffix, defaultValue } from 'app/shared/model/portfolio-my-suffix.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
  ...
  partialUpdateEntity,
  reset,
} from './portfolio-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<IPortfolioMySuffix> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
