...
import { getEntity, deleteEntity } from './cart-my-suffix.reducer';

export const CartMySuffixDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="onlineShopApp.cart.delete.question">Are you sure you want to delete Cart {cartEntity.id}?</ModalBody>
      <ModalFooter>
...
export default CartMySuffixDeleteDialog;
