...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './receipt-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECEIPT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RECEIPT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RECEIPT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RECEIPT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RECEIPT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RECEIPT actions', async () => {
      const arg = 42666;
