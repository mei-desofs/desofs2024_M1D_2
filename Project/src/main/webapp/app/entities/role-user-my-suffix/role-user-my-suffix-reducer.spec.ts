...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './role-user-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROLEUSER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ROLEUSER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ROLEUSER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ROLEUSER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ROLEUSER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ROLEUSER actions', async () => {
      const arg = 42666;
