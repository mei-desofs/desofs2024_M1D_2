...
import { getEntity, deleteEntity } from './user-my-suffix.reducer';

export const UserMySuffixDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="onlineShopApp.user.delete.question">Are you sure you want to delete User {userEntity.id}?</ModalBody>
      <ModalFooter>
...
export default UserMySuffixDeleteDialog;
