...
import { getEntity, deleteEntity } from './photo-my-suffix.reducer';

export const PhotoMySuffixDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="onlineShopApp.photo.delete.question">Are you sure you want to delete Photo {photoEntity.id}?</ModalBody>
      <ModalFooter>
...
export default PhotoMySuffixDeleteDialog;
