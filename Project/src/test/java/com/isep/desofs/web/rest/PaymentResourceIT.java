...
import static com.isep.desofs.domain.PaymentAsserts.*;
...
class PaymentResourceIT {
    ...
    void getAllPayments() throws Exception {
        ...
        restPaymentMockMvc
            ...
            .andExpect(jsonPath("$.[*].idCart").value(hasItem(DEFAULT_ID_CART.intValue())))
    ...
    void getPayment() throws Exception {
        ...
        restPaymentMockMvc
            ...
            .andExpect(jsonPath("$.idCart").value(DEFAULT_ID_CART.intValue()))
