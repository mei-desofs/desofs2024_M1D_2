...
import static backend.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static backend.test.util.OAuth2TestUtil.authenticationToken;
import static backend.test.util.OAuth2TestUtil.registerAuthenticationToken;
