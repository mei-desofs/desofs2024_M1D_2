...
import { sampleWithRequiredData } from '../role-my-suffix.test-samples';
...
describe('RoleMySuffix Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, RoleMySuffixComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to roleService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRoleMySuffixIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRoleMySuffixIdentifier).toHaveBeenCalledWith(entity);
