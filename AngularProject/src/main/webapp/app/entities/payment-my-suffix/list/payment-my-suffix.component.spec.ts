...
import { sampleWithRequiredData } from '../payment-my-suffix.test-samples';
...
describe('PaymentMySuffix Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, PaymentMySuffixComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to paymentService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPaymentMySuffixIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPaymentMySuffixIdentifier).toHaveBeenCalledWith(entity);
