...
export class PhotoMySuffixComponent implements OnInit {
  ...
  delete(photo: IPhotoMySuffix): void {
    const modalRef = this.modalService.open(PhotoMySuffixDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
