...
import { sampleWithRequiredData } from '../photo-my-suffix.test-samples';
...
describe('PhotoMySuffix Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, PhotoMySuffixComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to photoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPhotoMySuffixIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPhotoMySuffixIdentifier).toHaveBeenCalledWith(entity);
