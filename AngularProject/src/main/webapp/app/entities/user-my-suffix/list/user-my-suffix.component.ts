...
import { EntityArrayResponseType, UserMySuffixService } from '../service/user-my-suffix.service';
import { UserMySuffixDeleteDialogComponent } from '../delete/user-my-suffix-delete-dialog.component';

@Component({
  standalone: true,
  selector: 'jhi-user-my-suffix',
  templateUrl: './user-my-suffix.component.html',
  imports: [
    RouterModule,
    FormsModule,
    SharedModule,
...
export class UserMySuffixComponent implements OnInit {
