...
import { EntityArrayResponseType, RoleUserMySuffixService } from '../service/role-user-my-suffix.service';
import { RoleUserMySuffixDeleteDialogComponent } from '../delete/role-user-my-suffix-delete-dialog.component';

@Component({
  standalone: true,
  selector: 'jhi-role-user-my-suffix',
  templateUrl: './role-user-my-suffix.component.html',
  imports: [
    RouterModule,
    FormsModule,
    SharedModule,
...
export class RoleUserMySuffixComponent implements OnInit {
