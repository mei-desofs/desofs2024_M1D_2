...
/**
 * REST controller for managing {@link backend.domain.Cart}.
 */
@RestController
...
public class CartResource {
     ...
     */
    @PostMapping("")
    public Mono<ResponseEntity<CartDTO>> createCart(@RequestBody CartDTO cartDTO) throws URISyntaxException {
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<CartDTO>> getCart(@PathVariable("id") Long id) {
